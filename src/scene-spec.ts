...
export const SAMPLE_SCENE: SharedSceneSpecification = deepFreeze({
  ...
  entities: [
    ...
    entity('train-two-car', 'train', transform(0, 1.2, -24, 8, 2.4, 3), { archetype: 'train', variant: 'two-car' }, ['metal', 'accent'], collider(0, 1.2, -24, 8, 2.4, 3), [], ['train-loop']),
    ...
    entity('fence-north', 'fence', transform(0, 1, 25, 52, 2, 0.3), { archetype: 'safety-fence', variant: 'wood-post' }, ['wood'], collider(0, 1, 25, 52, 2, 0.3)),
